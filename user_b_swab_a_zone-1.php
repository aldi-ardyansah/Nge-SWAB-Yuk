        ...
        <nav class="navbar navbar-expand-lg" style="background-color: #e3f2fd;" data-bs-theme="light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="user_a_home.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="user_b_swab.php">SWAB</a>
                        </li>
                    </ul>
...
<div class="container-fluid p-4" style="background-color: rgb(255 255 255);">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-nowrap gap-1">
                                        ...
                                        <form action="user_b_swab_a_zone-1_c_delete.php" method="post">
        ...
        <div class="modal fade" id="addSWABZone1" tabindex="-1" aria-labelledby="addSWABZone1Label" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="user_b_swab_a_zone-1_a_add.php" method="post">
        ...
        <div class="modal fade" id="editSWABZone1" tabindex="-1" aria-labelledby="editSWABZone1Label" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="user_b_swab_a_zone-1_b_edit.php" method="post">
                        <div class="modal-header">
